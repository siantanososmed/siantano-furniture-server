...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quality: Schema.Attribute.Enumeration<['Export', 'Local']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sample: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    media: Schema.Attribute.Media<'files' | 'videos'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiProductColorProductColor
  ...
  attributes: {
    ...
    productMedia: Schema.Attribute.Media<'images' | 'files' | 'videos', true> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dimension: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weight: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiShowcaseImageShowcaseImage
  extends Struct.CollectionTypeSchema {
  collectionName: 'showcase_images';
  info: {
    displayName: 'ShowcaseImage';
    pluralName: 'showcase-images';
    singularName: 'showcase-image';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::showcase-image.showcase-image'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    showcase_points: Schema.Attribute.Relation<
      'oneToMany',
      'api::showcase-point.showcase-point'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiShowcasePointShowcasePoint
  extends Struct.CollectionTypeSchema {
  collectionName: 'showcase_points';
  info: {
    displayName: 'ShowcasePoint';
    pluralName: 'showcase-points';
    singularName: 'showcase-point';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    row: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    showcase_image: Schema.Attribute.Relation<
      'manyToOne',
      'api::showcase-image.showcase-image'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::showcase-image.showcase-image': ApiShowcaseImageShowcaseImage;
      'api::showcase-point.showcase-point': ApiShowcasePointShowcasePoint;
